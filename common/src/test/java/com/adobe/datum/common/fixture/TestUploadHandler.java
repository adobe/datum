 ...
 */
public class TestUploadHandler implements TestGenericType<DatumRequestProto, DatumMetadataMessage> {

  @Override
  public DatumRequestProto doSomething(DatumMetadataMessage metadataMessage) {
    return null;
  }
}

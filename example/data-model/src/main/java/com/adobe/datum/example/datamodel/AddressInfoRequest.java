...
@AllArgsConstructor
@NoArgsConstructor
public class AddressInfoRequest implements DatumExternalizable {

  private int count;

  @Override
  public AddressInfoRequest serialize(DataWriter writer) {
    writer.write(count);
    return this;
  }

  @Override
  public AddressInfoRequest deserialize(DataReader reader) {

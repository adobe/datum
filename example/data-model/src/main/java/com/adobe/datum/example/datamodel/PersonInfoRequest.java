...
@AllArgsConstructor
@NoArgsConstructor
public class PersonInfoRequest implements DatumExternalizable {

  private String query;

  @Override
  public PersonInfoRequest serialize(DataWriter writer) {
    writer.write(query);
    return this;
  }

  @Override
  public PersonInfoRequest deserialize(DataReader reader) {
